...
# Contributing to Tmux Config Data
...
[bug_tracker_opened_issues]: https://framagit.org/rdeville-private/dotfiles/tmux-data/issues/?sort=created_date&state=opened&or[label_name][]=Type%3A%3ABug&or[label_name][]=Type%3A%3ARegression&first_page_size=200
...
Tmux Config Data, **including completely new features and minor improvements to
...
[issues_page]: https://framagit.org/rdeville-private/dotfiles/tmux-data/-/issues
...
- You may want to **include screenshots or screen recordings** which help you
  ...
  instance).
- **Explain why this enhancement would be useful** to most Tmux Config Data users. You
...
[new_issues_page]: https://framagit.org/rdeville-private/dotfiles/tmux-data/-/issues/new
...
```text
[Tmux Config Data] - Join The Project Team
```
...
[README]: https://framagit.org/rdeville-private/dotfiles/tmux-data/-/blob/main/README.md
[CODE_OF_CONDUCT]: https://framagit.org/rdeville-private/dotfiles/tmux-data/-/blob/main/CODE_OF_CONDUCT.md
[documentation]: https://framagit.org/rdeville-private/dotfiles/tmux-data
